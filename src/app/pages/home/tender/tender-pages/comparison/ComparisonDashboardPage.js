...
export default class ComparisonDashboardPage extends React.Component {
    ...
    constructor(props) {
        ...
        Promise.all([getCpv(this.state.cpvs[0].id), getContractingAuthority(this.state.cas[0].id), getBusinessFields()]).then(response => {
    ...
    render() {
        return (
            ...
            <div className="row">
                                    ...
                                    <div className="kt-section">
                                        <div className="col-md-12">
                                            <div className="entity_compare">
                                                ...
                                                <div className="col-md-12" style={{position: 'relative', top: '0px'}}>
                                                    {
                                                        this.state.cpvs.map((d) => {

                                                            return (
                                                                <span style={{ paddingRight: '5px', paddingBottom: '5px'}}>
                                            {(
                                                <span> {d.nameEn} &nbsp;
                            ...
                            <div className="offersResults">
                                ...
                                <CodeExample beforeCodeTitle="Locations">
                                    <div className="kt-section">
                                        ...
                                        <div className="col-md-12" style={{position: 'relative', top: '0px', padding: '10px'}}>
                                            {
                ...
                <div className="col-md-6" style={{position: 'relative', top: '-60px'}}>
                    <div className="offersResults">
